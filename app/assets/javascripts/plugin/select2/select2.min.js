    ...
    if (window.Select2 === b) {
        ...
        K = a(document), I = function () {
            ...
            "addSelectedChoice": function (c) {
                var d, e, f = !c.locked,
                    g = a("<li style='display: inline-block; display: inline;' class='select2-search-choice'>    <div></div>    <a style='display: inline-block; display: inline;' href='#' class='select2-search-choice-close' tabindex='-1'><i class='fa fa-close' style='color:white'></i></a></li>"),
                    h = a("<li class='select2-search-choice select2-locked'><div></div></li>"),
                    i = f ? g : h,
                    j = this.id(c),
                    k = this.getVal();
                d = this.opts.formatSelection(c, i.find("div"), this.opts.escapeMarkup), d != b && i.find("div").replaceWith("" + d + ""), e = this.opts.formatSelectionCssClass(c, i.find("div")), e != b && i.addClass(e), f && i.find(".select2-search-choice-close").on("mousedown", p).on("click dblclick", this.bind(function (b) {
            ...
            "shouldFocusInput": function (a) {
                ...
                return b && a.opts.minimumResultsForSearch < 1 ? !1 : !0
            }
